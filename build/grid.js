...
;// CONCATENATED MODULE: ./src/options.ini.js
var OPTIONS = 
{
	scale			: 2,
	rows 			: 15,
...
function initGUI()
{
	var gui = new GUI$1({hideable: false});
...
var common = __webpack_require__(421);
...
const container 			= htmlToElement(`<div class='container'></div>`);
...
for (let x = 0; x < OPTIONS.rows; x++) 
{
	...
	var block 				= htmlToElement(`<img src='./img/blockB.png' class='tile' style='left: ${posX}px; top: ${posY}px;'/>`);
